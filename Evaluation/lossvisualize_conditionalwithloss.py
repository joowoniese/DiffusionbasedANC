...
file_path = "/hdd_ext/hdd3/joowoniese/diffwave4/ConditionalDiffwavewithLoss2/event_logs_plus/losslog.csv"
df = pd.read_csv(file_path)

# 사용할 열 목록
columns = ['loss', 'original_loss', 'custom_loss', 'grad_norm']
