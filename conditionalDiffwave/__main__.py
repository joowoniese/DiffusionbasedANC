...
if __name__ == '__main__':
  ...
  parser.add_argument('input_dirs', nargs='+',
                      help='space separated list of directories from which to read input .wav files for training')
  parser.add_argument('target_dirs', nargs='+',
                      help='space separated list of directories from which to read target .wav files for training')
